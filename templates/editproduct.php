    ...
    <div class="input-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="row">
            <div class="name col-lg-6 col-lg-offset-3 col-md-6 col-md-offset-3 col-sm-12 col-xs-12">
                ...
                <input type="text" class="form-control" id="name" placeholder="Xiaomi MI5">
            </div>
        </div>
        <div class="row">
            <div class="small-description col-lg-6 col-lg-offset-3 col-md-6 col-md-offset-3  col-sm-12 col-xs-12">
                <div class="form-group">
                    ...
                    <textarea class="form-control" rows="5" id="comment" placeholder="MIUI 8 4GB RAM Snapdragon 820 64bit Quad Core 2.15GHz 16.0MP + 4.0MP Cameras Type-C Quick Charge 3.0 NFC Front Fingerprint Sensor 3D Ceramic Body"></textarea>
                </div>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            <div class="name col-lg-6 col-lg-offset-3 col-md-6 col-md-offset-3  col-sm-12 col-xs-12">
                ...
                <input type="number" class="form-control" id="price" placeholder="375.42">
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            <div class="name col-lg-6 col-lg-offset-3 col-md-6 col-md-offset-3  col-sm-12 col-xs-12">
                ...
                <input type="number" class="form-control" id="qty" placeholder="60">
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            <div class="small-description col-lg-6 col-lg-offset-3 col-md-6 col-md-offset-3  col-sm-12 col-xs-12">
                <div class="form-group">
                    ...
                    <textarea class="form-control" rows="10" maxlength="5" id="comment" placeholder="MIUI 8 4GB RAM Snapdragon 820 64bit Quad Core 2.15GHz 16.0MP + 4.0MP Cameras Type-C Quick Charge 3.0 NFC Front Fingerprint Sensor 3D Ceramic Body"></textarea>
                </div>
            </div>
        </div>
